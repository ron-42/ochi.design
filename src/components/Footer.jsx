...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 flex py-20 px-14 pb-10 gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading w-full font-founders-grotesk uppercase">
          <h1 className="text-[8vw] leading-none -mb-8">EYE-</h1>
          <h1 className="text-[8vw] leading-none -mb-8">Openeing</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 ">
        <h1 className="text-[8vw] leading-none -mb-8 font-founders-grotesk uppercase">
          PRESENTATIONS
        </h1>
        <div className="w-full flex font-neue-montreal">
          <div className="w-1/2 mt-14">
            <div className="socials">
              <h3 className="mb-4">S:</h3>
              <a
                className="block text-lg font-extralight underline underline-offset-2"
                href="#"
              >
                Instagram
              </a>
            ...
            <div className="location mt-10">
              <h3>L:</h3>
              <a className="block mt-5 underline underline-offset-2" href="#">
          ...
          <div className="w-1/2 relative">
            <div className="M absolute top-[50%] right-[30%] ">
              <h3 className="mb-5">M:</h3>
              <a className="block underline underline-offset-2" href="#">
                Home
              </a>
              <a className="block underline underline-offset-2" href="#">
                Services
        ...
        <div className="footer font-neue-montreal w-full flex justify-between bottom-0 mt-6 text-zinc-500 font-medium">
          <h3>
            © ochi design 2024.
            <span className="underline underline-offset-2">Legal Terms</span>
          </h3>
          <h3 className="font-semibold">Website by Obys</h3>
        </div>
      </div>
    </div>
  );
